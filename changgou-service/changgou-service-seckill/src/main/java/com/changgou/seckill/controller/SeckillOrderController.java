...
public class SeckillOrderController {
    ...
    public Result queryStatus(){
        ...
        return new Result(true, StatusCode.OK, "查询订单成功", seckillStatus);
    }

    /**
     * @author 栗子
     * @Description 用户提交订单
     * @Date 11:20 2020/9/21
     * @param time
     * @param id
     * @return entity.Result
     **/
    ...
    public Result add(String time, Long id){
        ...
        String userId = "wangwu";
        Boolean aBoolean = seckillOrderService.add(time, id, userId);
        if (aBoolean){
            return new Result(true,StatusCode.OK,"恭喜你，抢单成功");
        }
        return new Result(true,StatusCode.OK,"sorry，抢单失败");
