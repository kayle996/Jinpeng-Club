...
public class UserController {
    ...
    public Result incr(@PathVariable(value = "username") String username,
                       @PathVariable(value = "points") String points){
        userService.incr(username, points);
