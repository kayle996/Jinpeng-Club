...
public class TemplateController {
    ...
    /**
     * @author 栗子
     * @Description 根据分类获取模板
     * @Date 10:44 2020/9/6
     * @param categoryId
     * @return entity.Result<com.changgou.goods.pojo.Template>
     **/
    @GetMapping("/findTemplateByCategoryId/{categoryId}")
    public Result<Template> findTemplateByCategoryId(@PathVariable(value = "categoryId") Integer categoryId){
        Template template = templateService.findTemplateByCategoryId(categoryId);
        return new Result<>(true, StatusCode.OK, "根据分类获取模板", template);
    }
