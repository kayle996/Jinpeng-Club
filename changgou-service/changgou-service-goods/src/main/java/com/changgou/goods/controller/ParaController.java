...
public class ParaController {
    ...
    @GetMapping("/findParaListByTempId/{tempId}")
    public Result<List<Para>> findParaListByTempId(@PathVariable(value = "tempId") Integer tempId){
        List<Para> list = paraService.findParaListByTempId(tempId);
        return new Result(true,StatusCode.OK,"查询商品参数列表成功",list);
    }
