...
public class SpecController {
    ...
    @GetMapping("/findSpecListByTempId/{tempId}")
    public Result<List<Spec>> findSpecList(@PathVariable(value = "tempId") Integer tempId){
        List<Spec> list = specService.findSpecList(tempId);
        return new Result<>(true, StatusCode.OK, "获取商品规格列表成功", list);
    }
